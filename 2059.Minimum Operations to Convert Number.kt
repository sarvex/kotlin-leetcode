internal class Solution {
  fun minimumOperations(nums: IntArray, start: Int, goal: Int): Int {
    val op1: IntBinaryOperator = IntBinaryOperator { x, y -> x + y }
    val op2: IntBinaryOperator = IntBinaryOperator { x, y -> x - y }
    val op3: IntBinaryOperator = IntBinaryOperator { x, y -> x xor y }
